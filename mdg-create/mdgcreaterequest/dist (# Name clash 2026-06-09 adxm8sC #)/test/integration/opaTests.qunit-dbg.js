...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "c4p/mdg/mdgcreaterequest/test/integration/FirstJourney",
    "c4p/mdg/mdgcreaterequest/test/integration/RequestsListJourney",
    "c4p/mdg/mdgcreaterequest/test/integration/RequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});

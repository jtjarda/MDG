...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "c4s/mdg/mdgsearch/test/integration/FirstJourney",
    "c4s/mdg/mdgsearch/test/integration/BusinessPartnerSearchListJourney",
    "c4s/mdg/mdgsearch/test/integration/BusinessPartnerSearchObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
